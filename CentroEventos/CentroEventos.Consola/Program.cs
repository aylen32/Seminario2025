...
using CentroEventos.Aplicacion.Enumeraciones;
...
class Program
{
    static void Main()
    {
        ...
        while (!salir)
        {
            ...
            string opcion = Console.ReadLine(); // Recibe la opcion elegida
            ...
            try
            {
                switch (opcion)
                {
                    ...
                    case "4":
                        var bajaPersona = new BajaPersonaUseCase(repoPersona, validadorPersona, repoReserva, repoEvento, servicioAutorizacion, idUsuario);
                    ...
                    case "9":
                        var altaReserva = new AltaReservaUseCase(repoReserva, validadorReserva, servicioAutorizacion, idUsuario);
                    ...
                    case "10":
                        ...
                        foreach (var reserva in listarReservas.Ejecutar())
                    ...
                    case "13":
                        ...
                        foreach (var asistente in listarAsistencia.Ejecutar(idEv))
